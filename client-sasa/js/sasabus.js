...
var SASABus = {
	...
	imageserver: 'http://sasatest.r3-gis.com/',
	...
	var merano = new OpenLayers.Bounds(676652, 5149450, 682089, 5153550);
        me.map.zoomToExtent(merano, true);
...
/*         stopsLayer.events.register('featuresadded', null, function() {
    ...
    getBusPositionLayer: function() {
        ...
        var styleMap = new OpenLayers.StyleMap({
            pointRadius: 12,
            externalGraphic: this.config.imageserver + 'images/${hexcolor2}.png'
        });
